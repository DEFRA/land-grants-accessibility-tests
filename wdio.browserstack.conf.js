...
export const config = {
  ...
  baseUrl: `https://land-grants-accessibility-tests.${process.env.ENVIRONMENT}.cdp-int.defra.cloud`,
  ...
  commonCapabilities: {
    'bstack:options': {
      buildName: `land-grants-accessibility-tests-${process.env.ENVIRONMENT}` // configure as required
    }
  },
    ...
    [
      'browserstack',
      {
        ...
        testObservabilityOptions: {
          ...
          buildName: `land-grants-accessibility-tests-${process.env.ENVIRONMENT}`
        },
